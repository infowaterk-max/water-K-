...
export default async function AccountDownloadsPage(){
  ...
  return <main className="section accountPage"><div className="shell"><div className="sectionIntro"><div><span className="eyebrow">Saját fiók</span><h1 className="sectionTitle">Letöltéseim</h1><p className="lead">A megvásárolt digitális tartalmakat innen töltheted le. A rendelési dokumentumok és a megvásárolt termékekhez tartozó fiókos segédanyagok ugyanitt, saját jogosultsági szabályaik szerint érhetők el.</p></div><Link className="btn" href="/fiokom">Vissza a fiókhoz</Link></div>
