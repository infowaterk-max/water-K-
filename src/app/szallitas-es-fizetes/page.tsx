...
export default async function ShippingPaymentPage(){
 ...
 return <StorefrontContentShell pageKey="legal"><main className="section"><div className="shell"><span className="eyebrow">{brand} · vásárlási információk</span><h1 className="sectionTitle">Szállítás és fizetés</h1><p className="lead">Az itt megjelenő lehetőségek az adott webáruház aktív szolgáltatói beállításaiból származnak.</p>
