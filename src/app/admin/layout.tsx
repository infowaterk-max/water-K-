...
const MERCHANT_NAV:NavItem[]=[
 ...
 {href:'/admin/marketing',label:'Marketing alapok',feature:'marketingBasics'},
 ...
 {href:'/admin/kampanyok',label:'Haladó kampányok',feature:'advancedCampaigns'},
 {href:'/admin/kommunikacio',label:'Digitális iroda',feature:'officeCommunication'},
 {href:'/admin/kommunikacio/tiltolista',label:'Kommunikációs tiltólista',feature:'officeCommunication'},
 {href:'/admin/ugyfelszolgalat',label:'Ügyfélszolgálat',feature:'support'},
 {href:'/admin/termekek',label:'Termékek',feature:'catalog'},
 {href:'/admin/termekajanlasok',label:'Termékajánlások',feature:'productRecommendations'},
 {href:'/admin/tartalom',label:'Tartalom és SEO',feature:'contentMarketing'},
 ...
 {href:'/admin/kuponok',label:'Kuponok és akciók',feature:'coupons'},
...
export default async function AdminLayout({children}:{children:React.ReactNode}){
 await requireAdmin();
 const [plan,operator]=await Promise.all([getCurrentPlan(),isPlatformOperator()]);
 const definition=PLANS[plan];
 return <main className="adminGrid"><aside className="adminSide"><strong>Water-K Admin</strong><span className="muted">{definition.name} csomag</span>
