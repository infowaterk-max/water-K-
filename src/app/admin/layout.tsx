...
export default async function AdminLayout({children}:{children:React.ReactNode}){
  ...
  const sections=isPlatform&&!instance?[]:resolveMerchantNavigation(effectivePlan,can);
