...
export default async function CommunicationSupervision(){
  ...
  return <section className="adminMain">
    <div className="sectionIntro"><div><span className="eyebrow">Pro · Ügyféllevelezés</span><h1 className="sectionTitle">Küldési felügyelet</h1><p className="lead">Technikai küldési sor, kézi jóváhagyások, audit és háttérfolyamatok. Ez nem külön kommunikációs csatorna, hanem az Ügyféllevelezés adminisztratív felügyelete.</p></div><Link className="btn btnPrimary" href="/admin/kommunikacio/iroda">Vissza az ügyféllevelezéshez</Link></div>
