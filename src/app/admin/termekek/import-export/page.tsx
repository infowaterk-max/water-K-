...
export default async function ProductImportExportPage(){
  ...
  return <section className="adminMain">
    ...
    <p className="lead">Kézi termékfelvitelhez, mező-hozzárendeléses CSV onboardinghoz, katalógusköltöztetéshez és tömeges szerkesztéshez használható, webshoponként elkülönített adatkapu.</p>{result.error&&<div className="errorNotice" role="alert"><strong>A jelenlegi katalógus most nem tölthető be.</strong> Importot és onboardingot addig nem engedünk, hogy ne módosítsunk ismeretlen kiinduló állapotot.</div>}
    <div className="cards">
      ...
      <section className="card"><span className="badge">Biztonság</span><h2>Draft-first és atomi apply</h2><p className="muted">Új termék csak piszkozatként jön létre. Az onboarding előnézete szerveroldali batchben rögzül; más webshop adata és kliensoldalon átírt apply-plan nem válhat authority-forrássá.</p><Link className="btn" href="/admin/termekek/tomeges">Tömeges műveletek</Link></section>
    </div>
