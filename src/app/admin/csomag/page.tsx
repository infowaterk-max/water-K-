...
export default async function PackagePage({ searchParams }: PackagePageProps) {
  ...
  return <section className="adminContent">
    ...
    {current === 'alap' ? <div className="card"><h2>Shoperation Pro bővítés</h2><p>A meglévő webshop és adatai megmaradnak; a digitális iroda és a fejlett üzleti modulok nyílnak meg.</p></div> : <div className="card"><h2>Minden Pro funkció aktív</h2><p>A külön extrák ettől függetlenül kapcsolhatók be.</p></div>}
  </section>;
}
