...
export default async function IntegrationJobDetail({params}:{params:Promise<{id:string}>}){
  ...
  return <section className="adminMain">
    <div className="adminToolbar"><div><span className="eyebrow">Admin · Integráció</span><h1 className="sectionTitle">{job.provider} · {kindLabel[job.kind]??job.kind}</h1></div><Link className="btn" href="/admin/beallitasok">Vissza</Link></div>
