...
export default async function LandingPage({params}:{params:Promise<{slug:string}>}){
  ...
  const structured={'@context':'https://schema.org','@type':'WebPage',name:item.title,description:item.seoDescription??item.excerpt??undefined,url:`${base}/oldal/${item.slug}`,dateModified:item.updatedAt,isPartOf:{'@type':'WebSite',name:'Water-K',url:base}};
