...
import {STOREFRONT_COMMERCE_HEADER_COMPONENT_DEFINITIONS} from '@/lib/builder/storefront-commerce-header';
...
import {STOREFRONT_GROWTH_MARKETING_COMPONENT_DEFINITIONS} from '@/lib/builder/storefront-growth-marketing';
import {STOREFRONT_SUPPORT_COMPONENT_DEFINITIONS} from '@/lib/builder/storefront-support';
import {STOREFRONT_ACCOUNT_NAVIGATION_COMPONENT_DEFINITIONS} from '@/lib/builder/storefront-account-navigation';
import {STOREFRONT_DIGITAL_COMMERCE_COMPONENT_DEFINITIONS} from '@/lib/builder/storefront-digital-commerce-surfaces';
import {StorefrontComponentRegistry,type StorefrontRuntimeComponentDefinition} from '@/lib/builder/storefront-runtime';
export const STOREFRONT_BUILDER_REGISTRY_VERSION='shoporation.storefront-builder-registry.special-commerce-v5' as const;
const DEFINITION_FAMILIES:readonly (readonly StorefrontRuntimeComponentDefinition[])[]=[STOREFRONT_PRIMITIVE_DEFINITIONS,STOREFRONT_COMMERCE_HEADER_COMPONENT_DEFINITIONS,STOREFRONT_CORE_COMMERCE_COMPONENT_DEFINITIONS,STOREFRONT_EDITORIAL_COMPONENT_DEFINITIONS,STOREFRONT_STRUCTURED_PRODUCT_COMPONENT_DEFINITIONS,STOREFRONT_GUIDED_FINDER_COMPONENT_DEFINITIONS,STOREFRONT_MULTI_PRODUCT_COMPOSER_COMPONENT_DEFINITIONS,STOREFRONT_CONFIGURATOR_COMPONENT_DEFINITIONS,STOREFRONT_CONTEXT_RETENTION_COMPONENT_DEFINITIONS,STOREFRONT_PROFESSIONAL_COMPONENT_DEFINITIONS,STOREFRONT_STORY_COMPONENT_DEFINITIONS,STOREFRONT_VISUAL_LAYER_COMPONENT_DEFINITIONS,STOREFRONT_PURCHASE_CONTROLS_COMPONENT_DEFINITIONS,STOREFRONT_SHARED_CONTENT_COMPONENT_DEFINITIONS,STOREFRONT_INTERACTIVE_SCENE_COMPONENT_DEFINITIONS,STOREFRONT_RECIPE_COMMERCE_COMPONENT_DEFINITIONS,STOREFRONT_RELEASE_COMMERCE_COMPONENT_DEFINITIONS,STOREFRONT_GROWTH_MARKETING_COMPONENT_DEFINITIONS,STOREFRONT_SUPPORT_COMPONENT_DEFINITIONS,STOREFRONT_ACCOUNT_NAVIGATION_COMPONENT_DEFINITIONS,STOREFRONT_DIGITAL_COMMERCE_COMPONENT_DEFINITIONS] as const;
