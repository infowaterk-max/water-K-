...
export const STOREFRONT_STORY_COMPONENT_DEFINITIONS:readonly StorefrontRuntimeComponentDefinition[]=[
  ...
  storyDefinition({componentKey:'story.feature',pageTypes:['home','content','product','blog-index','blog-article'],configurable:['eyebrow','title','copy','image','imageAlt','ctaLabel','ctaHref','imagePosition','tone','relationLabel'],bindingSlots:['eyebrow','title','copy','image','imageAlt','ctaLabel','ctaHref','relationLabel'],responsiveMode:'grid'}),
