...
import {STOREFRONT_SHARED_CONTENT_COMPONENT_DEFINITIONS,STOREFRONT_SHARED_CONTENT_VERSION} from '@/lib/builder/storefront-shared-content';

export const STOREFRONT_GUIDED_VISUAL_COMPONENTS_VERSION='shoporation.storefront-guided-visual-components.v3' as const;

/**
 * Shared composition used by templates that need deterministic Guided Finder,
 * independent visual layers, common purchase controls and reusable fidelity content.
 * This is registry composition only; it creates no pricing/inventory/evidence authority.
 */
...
export const STOREFRONT_GUIDED_VISUAL_COMPONENT_DEPENDENCIES=Object.freeze({
  ...
  sharedContent:STOREFRONT_SHARED_CONTENT_VERSION,
