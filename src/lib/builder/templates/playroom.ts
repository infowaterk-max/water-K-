...
export const PLAYROOM_HOME_PAGE=base('playroom.home','home',[
  ...
  section('playroom-trust',[grid('playroom-trust-grid',[trustItem('playroom-trust-discovery','✦','Valódi kínálat','A felfedezés a webshop tényleges katalógusából épül.'),trustItem('playroom-trust-platform','⌁','Platform szerint','A platformadatok strukturált termékadatokra támaszkodnak.'),trustItem('playroom-trust-together','∞','Játssz együtt','Közös játékhoz szervezett, szerkeszthető felfedezési utak.'),trustItem('playroom-trust-safe','✓','Biztonságos checkout','A végső rendelési validáció a közös commerce authority feladata.')],12,'s')],'background',{spacing:'s'}),
