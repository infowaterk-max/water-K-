...
export const SPEC_LAB_TEMPLATE_KEY='tech.spec-lab' as const;
export const SPEC_LAB_TEMPLATE_VERSION=1 as const;
export const SPEC_LAB_LEGACY_WORKING_NAME='Tech Command' as const;
...
export const SPEC_LAB_VISUAL_DNA=Object.freeze({
  ...
  density:'structured-specialist-technical',
  exclusions:['gamer-rgb','neon-rainbow','white-background-block','sterile-saas','fake-specification','fake-compatibility','fake-performance-guarantee','fake-trade-in-valuation'],
} as const);
...
export const SPEC_LAB_FAQ_PAGE=simple('spec-lab.faq','faq','GYIK','Specifikációs, kompatibilitási, setup és rendelési kérdések.');
export const SPEC_LAB_CONTACT_PAGE=simple('spec-lab.contact','contact','Kapcsolat','Műszaki és kereskedői kapcsolatfelvétel.');
