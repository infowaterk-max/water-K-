...
import {BEAUTY_LAB_TEMPLATE_PACKAGE as BEAUTY_LAB_REFERENCE_PACKAGE} from '@/lib/builder/templates/beauty-lab-reference-v28';
...
export const BEAUTY_LAB_TEMPLATE_PACKAGE:StorefrontInstallableTemplatePackage={
  ...
  pages:BEAUTY_LAB_REFERENCE_PACKAGE.pages.map(page=>({
    ...
    metadata:{
      ...
      canonicalTemplateSource:'beauty-lab-reference-v28',
    },
  })),
};
