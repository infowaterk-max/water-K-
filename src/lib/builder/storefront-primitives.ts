...
export const STOREFRONT_PRIMITIVE_DEFINITIONS:readonly StorefrontRuntimeComponentDefinition[]=[
  ...
  {manifest:manifest({componentKey:'system.header',schemaSlot:'protected.header',configurable:['brandLabel','brandHref','brandLogoSrc','brandLogoAlt','showBrandText','tagline','showNavigation','showUtilities','utilityItems','showSearch','searchHref','showAccount','accountHref','showCart','cartHref','mobileMenu','tone','sticky','spacing','width','gap','align','justify','size','backgroundColor','color','behavior','presentation','style','styleSlots','innerStyle','brandStyle','taglineStyle','utilityStyle','mobileToggleStyle'],responsiveMode:'primary-navigation'}),bindingSlots:['brandLabel','brandHref'],allowsChildren:true,allowedChildren:['system.navigation'],protectedSystem:true},
...
export const STOREFRONT_NEUTRAL_REFERENCE_PAGE:StorefrontPageDocument={
  ...
  sections:[
    ...
    node({
      ...
      children:[node({
        id:'reference-hero-container',
        componentKey:'layout.container',
        componentVersion:1,
        config:{width:'content',spacing:'none'},
        children:[node({
          id:'reference-hero-stack',
          componentKey:'layout.stack',
          componentVersion:1,
          config:{direction:'vertical',gap:'m',align:'start',justify:'start'},
          children:[
            node({id:'reference-title',componentKey:'content.heading',componentVersion:1,config:{text:'Semleges storefront referencia',level:1,align:'left',tone:'text'}}),
            node({id:'reference-copy',componentKey:'content.text',componentVersion:1,config:{text:'Ez az oldal kizárólag a közös Page Schema, registry, binding és renderer működését bizonyítja.',as:'p',align:'left',tone:'muted'}}),
            node({id:'reference-cta',componentKey:'content.button',componentVersion:1,config:{label:'Katalógus megnyitása',href:'/webaruhaz',variant:'primary',size:'m',ariaLabel:'Katalógus megnyitása'}}),
          ],
        })],
      })],
    }),
          ...
          children:[
            ...
            node({
              ...
              children:[node({
                ...
                componentVersion:1,
                config:{text:'Merchant brand binding',as:'strong',align:'left',tone:'muted'},
                bindings:{text:{path:'brand.name',fallback:'Merchant brand'}},
              })],
            }),
          ],
        })],
