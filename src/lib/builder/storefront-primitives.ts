...
export const STOREFRONT_PRIMITIVE_DEFINITIONS:readonly StorefrontRuntimeComponentDefinition[]=[
  {manifest:manifest({componentKey:'layout.section',schemaSlot:'sections',configurable:['tone','spacing','width','presentation','style','styleSlots','innerStyle'],responsiveMode:'container'}),allowsChildren:true},
  ...
  {manifest:manifest({componentKey:'content.heading',schemaSlot:'children',configurable:['text','level','align','tone','presentation','accentText','style','accentStyle','styleSlots'],responsiveMode:'fixed'}),bindingSlots:['text']},
  {manifest:manifest({componentKey:'content.text',schemaSlot:'children',configurable:['text','as','align','tone','presentation','style','styleSlots'],responsiveMode:'fixed'}),bindingSlots:['text']},
  ...
  {manifest:manifest({componentKey:'content.button',schemaSlot:'children',configurable:['label','href','variant','size','ariaLabel','presentation','style','styleSlots'],responsiveMode:'fixed'}),bindingSlots:['label','href']},
