...
export const TEMPLATE_FACTORY_AUTHORITY_GRAPH:readonly TemplateFactoryAuthorityRule[]=Object.freeze([
  ...
  {id:'TF-AUTH-018',subject:'complete storefront showroom inventory',owner:'quality-system',delegates:['factory','template'],rule:'A Factory candidate must own and demonstrate every canonical shopper-facing Page Schema and every required shell navigation surface; a rendered 14-page matrix alone is not completeness proof.'},
...
export const TEMPLATE_FACTORY_KNOWN_FAILURES:readonly TemplateFactoryKnownFailure[]=Object.freeze([
  ...
  },
  {
    ...
    symptom:'The Factory candidate renders a canonical page in isolation, but the shopper cannot reach the corresponding surface from the template navigation or required journey.',
    rootCause:'Page-count acceptance was treated as storefront completeness without a canonical navigation and reachability inventory.',
