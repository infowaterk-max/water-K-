...
export const LOOT_VAULT_V2_MEDIA_ASSETS:readonly StorefrontTemplateFactoryMediaAsset[]=Object.freeze([
  ...
  {key:'product-2',state:'internal-reference',referenceSrc:'https://images.pexels.com/photos/20014265/pexels-photo-20014265.jpeg?auto=compress&cs=tinysrgb&w=1200',role:'product',src:MEDIA.product2,alt:'Fantasy collector szobor',pageTypes:['home','product'],representative:true,aspectRatio:'4:5'},
  {key:'product-3',state:'internal-reference',referenceSrc:'https://images.pexels.com/photos/11556378/pexels-photo-11556378.jpeg?auto=compress&cs=tinysrgb&w=1200',role:'product',src:MEDIA.product3,alt:'Dramatikus warrior collector szobor',pageTypes:['home','product'],representative:true,aspectRatio:'4:5'},
  {key:'product-4',state:'internal-reference',referenceSrc:'https://images.pexels.com/photos/5795420/pexels-photo-5795420.jpeg?auto=compress&cs=tinysrgb&w=1200',role:'product',src:MEDIA.product4,alt:'Popkulturális collector display',pageTypes:['home','product'],representative:true,aspectRatio:'4:5'},
  {key:'editorial-1',state:'internal-reference',referenceSrc:'https://images.pexels.com/photos/5795419/pexels-photo-5795419.jpeg?auto=compress&cs=tinysrgb&w=1600',role:'editorial',src:MEDIA.editorial1,alt:'Gyűjtői polc figurákkal és művészeti tárgyakkal',pageTypes:['home','blog-index'],representative:true,aspectRatio:'3:2'},
  {key:'editorial-2',state:'internal-reference',referenceSrc:'https://images.pexels.com/photos/5795420/pexels-photo-5795420.jpeg?auto=compress&cs=tinysrgb&w=1600',role:'editorial',src:MEDIA.editorial2,alt:'Gazdag popkulturális gyűjtemény',pageTypes:['home','blog-article'],representative:true,aspectRatio:'3:2'},
