...
type Factory<T>=()=>T;
const paymentAdapters:Record<string,Factory<PaymentGateway>>={kh:()=>new KhPaymentGateway(),stripe:()=>new StripePaymentGateway(),simplepay:()=>new SimplePayPaymentGateway()};
