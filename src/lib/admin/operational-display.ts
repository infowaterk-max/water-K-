...
export const operationalStatusLabels:Record<string,string>={
  open:'Nyitott',new:'Új',queued:'Sorban',awaiting_reservation:'Készletfoglalásra vár',reserved:'Készlet lefoglalva',blocked:'Blokkolt',ready_to_pack:'Csomagolható',packing:'Csomagolás alatt',packed:'Becsomagolva',ready_to_ship:'Feladásra kész',handed_over:'Futárnak átadva',shipped:'Feladva',delivered:'Kézbesítve',completed:'Lezárt',cancelled:'Törölve',on_hold:'Felfüggesztve',
};
export const customerTierLabels:Record<string,string>={
  standard:'Standard',silver:'Ezüst',gold:'Arany',platinum:'Prémium',regular:'Visszatérő',valuable:'Értékes',high_value:'Magas értékű',vip:'VIP',at_risk:'Megtartást igényel',
};
export const alertStatusLabels:Record<string,string>={
  open:'Nyitott',acknowledged:'Átvett',snoozed:'Elhalasztva',resolved:'Megoldott',dismissed:'Elvetve',closed:'Lezárt',
};
