...
const guides:Record<string,ProviderGuide>={
 ...
 barion:{contract:'Aktív Barion elfogadóhely és kereskedői hozzáférés.',requirements:[{key:'BARION_POS_KEY',label:'POSKey',secret:true}],verification:'Barion POSKey és API-kapcsolat ellenőrzése.'},
