...
export function CookieConsent(){
  ...
  return <div className="cookieBanner" role="dialog" aria-live="polite" aria-label="Analitikai hozzájárulás">
    <div><strong>Segítesz jobbá tenni a Water-K oldalt?</strong><p>Az alap működéshez szükséges technikai tároláson felül csak hozzájárulás után használunk analitikai mérést.</p><Link href="/adatvedelem">Adatkezelési tájékoztató</Link></div>
