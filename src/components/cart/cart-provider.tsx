...
type CartContextValue={cart:Cart;items:CartItem[];total:number;add:(item:CartItem)=>void;addMany:(items:readonly CartItem[])=>void;remove:(productId:string,variantId?:string|null)=>void;setQuantity:(productId:string,quantity:number,variantId?:string|null)=>void;replace:(items:CartItem[])=>void;clear:()=>void};
