...
function CartChevronIcon({direction}:{direction:'up'|'down'}){
  return <svg aria-hidden="true" viewBox="0 0 12 8" width="9" height="6" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{display:'block'}}><path d={direction==='up'?'M2 6 6 2l4 4':'M2 2l4 4 4-4'}/></svg>;
}
