...
import{resolveCurrentStorefrontContentRuntimePage}from'@/lib/builder/storefront-runtime-source';
...
export async function StorefrontContentShell({children}:{children:ReactNode}){
 const runtime=await resolveCurrentStorefrontContentRuntimePage();
 ...
 return <div className="storefrontContentShell" data-storefront-content-shell={runtime.source} data-storefront-template={runtime.page.templateKey} style={{...vars,fontFamily:'var(--shoporation-body-font,Arial,sans-serif)',background:'var(--shoporation-color-background,#fff)',color:'var(--shoporation-color-text,#111827)'}}>
