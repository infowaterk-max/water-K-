...
export function CheckoutForm({shippingOptions,paymentOptions,freeShippingThreshold,resellerApproved,embedded=false,acceptancePreview=false,instanceId,signedIn=false,loyaltyEnabled=false}:{shippingOptions:ShippingOption[];paymentOptions:PaymentOption[];freeShippingThreshold:number;resellerApproved:boolean;embedded?:boolean;acceptancePreview?:boolean;instanceId:string|null;signedIn?:boolean;loyaltyEnabled?:boolean}){
