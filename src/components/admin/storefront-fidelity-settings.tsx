...
export function StorefrontFidelitySettings({document,viewport,onApply}:{
  ...
  return <div className={styles.editorFields}>
    ...
    {advanced?<div className={styles.fieldGroup}>
    ...
    </div>:<div className={styles.fieldGroup}><strong>Responsive kompozíció</strong><p className={styles.emptyHint}>A külön Desktop/Tablet/Mobil sorrend a Haladó módban érhető el. A Normál mód szándékosan egyszerűbb és biztonságosabb.</p></div>}
  </div>;
}
