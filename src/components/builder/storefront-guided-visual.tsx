...
import {STOREFRONT_SHARED_CONTENT_RENDERERS,STOREFRONT_SHARED_CONTENT_RENDERERS_VERSION} from '@/components/builder/storefront-shared-content';

export const STOREFRONT_GUIDED_VISUAL_RENDERERS_VERSION='shoporation.storefront-guided-visual-renderers.v3' as const;

/** Shared renderer composition for Page Schemas combining guided, visual, purchase and fidelity-content surfaces. */
...
export const STOREFRONT_GUIDED_VISUAL_RENDERER_DEPENDENCIES=Object.freeze({
  ...
  sharedContent:STOREFRONT_SHARED_CONTENT_RENDERERS_VERSION,
} as const);
