...
const protectedPagesAndActions = [
  ...
  ['src/app/admin/intezkedesek/page.tsx', 'executiveAnalytics'],
...
const protectedApis = [
  ...
  ['src/app/api/admin/actions/run/route.ts', 'executiveAnalytics'],
  ['src/app/api/admin/actions/proposal/route.ts', 'executiveAnalytics'],
