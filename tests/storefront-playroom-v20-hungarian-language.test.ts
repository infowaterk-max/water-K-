...
describe('Playroom v20 Hungarian storefront language gate',()=>{
  ...
  it('keeps the digital-commerce labels localized explicitly',()=>{
    ...
    for(const expected of['LETÖLTÉSEK','Dokumentumok','Digitális termék','Letöltéseim','VÁSÁRLÁS UTÁN','SAJÁT TÁR','ÜGYFÉLSZOLGÁLAT'])expect(serialized).toContain(expected);
