...
begin
  for f in
    ...
    where n.nspname='public' and p.proname=any(array[
      'place_order_provider','place_order_provider_v2',
...
-- Only the tenant-aware application RPCs remain callable by the trusted service role.
do $$
declare f record;
begin
  for f in
    ...
    from pg_proc p join pg_namespace n on n.oid=p.pronamespace
    where n.nspname='public' and p.proname=any(array[
      'place_order_provider_v3_idempotent',
