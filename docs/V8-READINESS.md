...
- Customer-service tickets with threaded customer/admin conversation and state integrity.
...
8. Open a support ticket; exchange customer/admin messages; verify closed-thread protection.
