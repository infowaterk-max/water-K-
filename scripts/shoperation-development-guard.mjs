...
const manifest={contract:'shoporation.development-guard.v1',task,plannedFiles:files,guardDigest:digest,scope,atlasContext,activeAuthorities,activeFailureIds:scope.activeFailureIds,activeFailures,negativeKnowledge,requiredRegressionTests,generalRules:guardPolicy.generalRules,decision};
